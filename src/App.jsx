  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans relative">
      ...
      <main className="pt-20"> 
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-2xl md:text-4xl font-light italic leading-relaxed text-gray-800">
              ...
              <section className="pt-16 pb-2 px-6"> 
                <div className="max-w-7xl mx-auto border-b border-gray-100 pb-6">
                  <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                      ...
                      <h2 className="text-3xl md:text-5xl font-black tracking-tighter uppercase leading-none">
                        Featured <span className="text-gray-300">Products</span>
                      </h2>
                    </div>
        ...
        <div id="shop" className="max-w-7xl mx-auto px-6 py-4">
          <ProductGrid 
